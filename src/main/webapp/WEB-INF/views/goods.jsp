...
<body>
  ...
  <div class="card">
    <div class="content">
      ...
      <p class="copy">이동욱 멱살잡는 농장주가 직접 키운 친환경</p>
  ...
  <div class="card">
    <div class="content">
      ...
      <button class="btn" onclick="location.href='/opalproject/details';">동규네 비트주세요 보러가기</button>
    </div>
  </div>
   ...
   <div class="card">
    <div class="content">
      ...
      <button class="btn" onclick="location.href='/opalproject/details';">지혜네 효소원 보러가기</button>
    </div>
  </div>
    ...
    <div class="content">
      ...
      <button class="btn" onclick="location.href='/opalproject/details';">성진이네 보리지혜 보러가기</button>
    </div>
  </div> 
    ...
    <div class="content">
      ...
      <button class="btn" onclick="location.href='/opalproject/details';">성연이네 양파남 보러가기</button>
    </div>
  </div>
  ...
  <div class="card">
    <div class="content">
      ...
      <button class="btn" onclick="location.href='/opalproject/details';">수이네 생강 보러가기</button>
    </div>
  </div> 
  ...
  <div class="card">
    <div class="content">
      ...
      <button class="btn" onclick="location.href='/opalproject/details';">규영이네 녹차 보러가기</button>
    </div>
  </div> 
  ...
  <div class="card">
    <div class="content">
      ...
      <button class="btn" onclick="location.href='/opalproject/details';">희정이네 도라쥐 보러가기</button>
    </div>
  </div> 
   ...
   <div class="card">
    <div class="content">
      ...
      <button class="btn" onclick="location.href='/opalproject/details';">세호네 양배추즙 보러가기</button>
    </div>
  </div>
  ...
  <div class="card">
    <div class="content">
      ...
      <button class="btn" onclick="location.href='/opalproject/details';">찬우네 마늘장아찌 보러가기</button>
    </div>
  </div> 
    ...
    <div class="content">
      ...
      <button class="btn" onclick="location.href='/opalproject/details';">소연이네 꿀농장 보러가기</button>
    </div>
  </div> 
